...
if __name__ == "__main__":
    ...
    # cap = cv2.VideoCapture(r'C:\Users\Hi Windows 11 Home\Documents\sign_recognition\Sign-Language-Classification\Dataset\Video_1\IMG_4589.MOV')
    ...
    # data_path = r"C:\Users\Hi Windows 11 Home\Documents\sign_recognition\Sign-Language-Classification\data_4"
    # os.makedirs(data_path, exist_ok=True)
    # # Lưu dữ liệu vào thư mục
    # pose_data = np.array(pose_data)
    # np.save(os.path.join(data_path, f"{args.pose_name}.npy"), pose_data)
    # print(f"Dữ liệu đã được lưu thành công tại {data_path} với tên {args.pose_name}.npy")
